...
Expected: `tsc` silent; the suite prints its `✅`. **The count assertions will FAIL until the operator has pasted the 11 known-item queries** — that is correct and expected. Report it; do not weaken the assertion to make it pass.
