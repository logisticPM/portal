...
a phantom limitation. The live **three-engine comparison (`./03-rap-engine-comparison.md`,
...
1. **A one-page runbook / deploy guide.** ✅ **DONE — [`DEPLOY-RUNBOOK.md`](./02-deploy-runbook.md).**
