...
// ===========================================================================
import type { Confirmation, Party, ReportedLine } from "../repo/types";
...
export const parties: Party[] = [
  ...
  { id: "s-eagle", role: "supplier", name: "Eagle River Construction", identityTier: "nation", registered: true, createdAt: T },
  { id: "s-raven", role: "supplier", name: "Raven Logistics", identityTier: "ccab", registered: true, createdAt: T },
  { id: "s-thunderbird", role: "supplier", name: "Thunderbird IT Services", identityTier: "ccab", registered: true, createdAt: T },
  { id: "s-sweetgrass", role: "supplier", name: "Sweetgrass Catering", identityTier: "self_declared", registered: true, createdAt: T },
  { id: "s-cedarsage", role: "supplier", name: "Cedar & Sage Consulting", identityTier: "nation", registered: true, createdAt: T },
  { id: "s-salish", role: "supplier", name: "Salish Office Supplies", identityTier: "self_declared", registered: true, createdAt: T },
];
...
export const lines: ReportedLine[] = [
  ...
  L("l-5", "c-cedartrust", "s-cedarsage", 620_000, "confirmed"),
  L("l-6", "c-cedartrust", "s-raven", 150_000, "pending"),
  L("l-7", "c-cedartrust", "s-salish", 40_000, "confirmed"),
  L("l-8", "c-mapletel", "s-thunderbird", 900_000, "confirmed"),
