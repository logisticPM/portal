...
export const parties: Party[] = [
  ...
  { id: "s-bouchier", role: "supplier", name: "The Bouchier Group", identityTier: "ccab", ownershipPct: 100, sector: "Logistics & site services", sectorNorm: "transport", region: "AB", regionNorm: "AB", website: "https://bouchier.ca/", blurb: "Indigenous-owned logistics, civil contracting and facility services in the Athabasca oil sands.", profilePublic: true, verifications: [{ source: "ccib", reference: "CCAB Certified (PAR Gold)", status: "verified", verifiedAt: "2025-02-01T00:00:00.000Z", expiresAt: "2028-02-01", verifiedBy: "CCAB" }] as Verification[], registered: true, createdAt: T },
  ...
  { id: "s-animikii", role: "supplier", name: "Animikii", identityTier: "ccab", ownershipPct: 100, sector: "Technology & software", sectorNorm: "telecom", region: "BC", regionNorm: "BC", website: "https://animikii.com/", blurb: "100% Indigenous-owned technology and software agency (Certified B Corporation).", profilePublic: true, verifications: [{ source: "ccib", reference: "CCAB Certified Indigenous Business", status: "verified", verifiedAt: "2025-02-05T00:00:00.000Z", expiresAt: "2028-02-05", verifiedBy: "CCAB" }] as Verification[], registered: true, createdAt: T },
  { id: "s-ntg", role: "supplier", name: "Nations Translation Group", identityTier: "ccab", ownershipPct: 51, sector: "Language & professional services", sectorNorm: "consulting", region: "ON", regionNorm: "ON", website: "https://www.nationstranslation.com/", blurb: "Canada's largest Indigenous-owned language-services provider (100+ languages).", profilePublic: true, verifications: [{ source: "ccib", reference: "CCAB Certified Indigenous Business", status: "verified", verifiedAt: "2025-02-10T00:00:00.000Z", expiresAt: "2028-02-10", verifiedBy: "CCAB" }] as Verification[], registered: true, createdAt: T },
