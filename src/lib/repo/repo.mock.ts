...
const parties: Party[] = [
  ...
  { id: "s-thunderbird", role: "supplier", name: "Thunderbird IT Services", identityTier: "ccab", ownershipPct: 75, sectorNorm: "consulting", verifications: [{ source: "isc_ibd", reference: "IBD-44120", status: "verified", verifiedAt: "2025-03-01T00:00:00.000Z", verifiedBy: "ISC" }], registered: true, createdAt: now() },
  { id: "s-sweetgrass", role: "supplier", name: "Sweetgrass Catering", identityTier: "self_declared", ownershipPct: 35, sector: "Catering", sectorNorm: "retail", region: "SK", regionNorm: "SK", blurb: "Event and corporate catering.", profilePublic: true, verifications: [{ source: "ccib", reference: "CIB-pending", status: "pending" }], registered: true, createdAt: now() },
  { id: "s-cedarsage", role: "supplier", name: "Cedar & Sage Consulting", identityTier: "nation", ownershipPct: 100, sectorNorm: "consulting", verifications: [{ source: "nation", reference: "MNBC-2023-77", status: "verified", verifiedAt: "2025-01-05T00:00:00.000Z", verifiedBy: "Métis Nation BC" }], registered: true, createdAt: now() },
  { id: "s-salish", role: "supplier", name: "Salish Office Supplies", identityTier: "self_declared", ownershipPct: 30, sectorNorm: "retail", verifications: [], registered: true, createdAt: now() },
  { id: "s-kiewitledcor", role: "supplier", name: "Kiewit-Ledcor Indigenous JV", identityTier: "ccab", ownershipPct: 51, sector: "Construction", sectorNorm: "construction", region: "AB", regionNorm: "AB", blurb: "Major-projects civil construction joint venture.", profilePublic: true, verifications: [{ source: "ccib", reference: "CIB-51002", status: "verified", verifiedAt: "2025-01-05T00:00:00.000Z", expiresAt: "2027-01-05", verifiedBy: "CCIB" }], registered: true, createdAt: now() },
  { id: "s-profinancial", role: "supplier", name: "Pro-Financial Indigenous Advisory", identityTier: "nation", ownershipPct: 100, sector: "Finance", sectorNorm: "finance", region: "ON", regionNorm: "ON", blurb: "Indigenous-owned financial advisory & capital markets services.", profilePublic: true, verifications: [{ source: "nation", reference: "BCR-2025-101", status: "verified", verifiedAt: "2025-02-01T00:00:00.000Z", expiresAt: "2027-02-01", verifiedBy: "Chippewas of Rama" }], registered: true, createdAt: now() },
  { id: "s-threenations", role: "supplier", name: "Three Nations Energy", identityTier: "nation", ownershipPct: 100, sector: "Energy", sectorNorm: "energy", region: "AB", regionNorm: "AB", blurb: "Indigenous-owned solar and grid infrastructure.", profilePublic: true, verifications: [{ source: "nation", reference: "BCR-2024-088", status: "verified", verifiedAt: "2024-11-01T00:00:00.000Z", expiresAt: "2026-11-01", verifiedBy: "Fort Chipewyan" }], registered: true, createdAt: now() },
  { id: "s-mikisew", role: "supplier", name: "Mikisew Energy Services", identityTier: "ccab", ownershipPct: 100, sector: "Energy", sectorNorm: "energy", region: "AB", regionNorm: "AB", blurb: "Site services, logistics and industrial support for energy operators.", profilePublic: true, verifications: [{ source: "ccib", reference: "CIB-22119", status: "verified", verifiedAt: "2025-01-10T00:00:00.000Z", expiresAt: "2027-01-10", verifiedBy: "CCIB" }], registered: true, createdAt: now() },
  { id: "s-northernrail", role: "supplier", name: "Northern Rail & Transport", identityTier: "ccab", ownershipPct: 60, sector: "Logistics", sectorNorm: "transport", region: "MB", regionNorm: "MB", blurb: "Freight and rail-adjacent logistics across northern Canada.", profilePublic: true, verifications: [{ source: "ccib", reference: "CIB-30455", status: "verified", verifiedAt: "2025-02-15T00:00:00.000Z", expiresAt: "2027-02-15", verifiedBy: "CCIB" }], registered: true, createdAt: now() },
];
