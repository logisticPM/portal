...
export const orgs: RapOrganization[] = [
  { id: "org-boc", name: "Bank of Canada", sector: "finance", sizeBand: "1000_plus", region: "ON", createdAt: "2024-09-01T00:00:00.000Z", ...noRegistry, dataClass: "public" },
  { id: "org-rbc", name: "Royal Bank of Canada", sector: "finance", sizeBand: "1000_plus", region: "ON", createdAt: "2025-06-20T00:00:00.000Z", ...noRegistry, dataClass: "public" },
  { id: "org-telus", name: "TELUS Communications", sector: "telecom", sizeBand: "1000_plus", region: "BC", createdAt: "2021-11-29T00:00:00.000Z", ...noRegistry, dataClass: "public" },
  { id: "org-agnico", name: "Agnico Eagle Mines", sector: "mining", sizeBand: "1000_plus", region: "ON", createdAt: "2024-07-10T00:00:00.000Z", ...noRegistry, dataClass: "public" },
  { id: "org-enbridge", name: "Enbridge", sector: "energy", sizeBand: "1000_plus", region: "AB", createdAt: "2022-01-01T00:00:00.000Z", ...noRegistry, dataClass: "public" },
  { id: "org-suncor", name: "Suncor Energy", sector: "energy", sizeBand: "1000_plus", region: "AB", createdAt: "2023-01-01T00:00:00.000Z", ...noRegistry, dataClass: "public" },
  { id: "org-tcenergy", name: "TC Energy", sector: "energy", sizeBand: "1000_plus", region: "AB", createdAt: "2023-01-01T00:00:00.000Z", ...noRegistry, dataClass: "public" },
  { id: "org-cnq", name: "Canadian Natural Resources", sector: "energy", sizeBand: "1000_plus", region: "AB", createdAt: "2024-01-01T00:00:00.000Z", ...noRegistry, dataClass: "public" },
  { id: "org-teck", name: "Teck Resources", sector: "mining", sizeBand: "1000_plus", region: "BC", createdAt: "2024-01-01T00:00:00.000Z", ...noRegistry, dataClass: "public" },
  { id: "org-gc", name: "Government of Canada", sector: "government", sizeBand: "1000_plus", region: "CA", createdAt: "2024-01-01T00:00:00.000Z", ...noRegistry, dataClass: "public" },
];
...
export const commitments: Commitment[] = [
  ...
  { id: "rc-boc-workforce", rapId: "rap-boc-2024", orgId: "org-boc", sector: "finance", pillar: "employment", commitmentType: "employment", action: "Grow Indigenous representation in the workforce", deliverable: "Recruitment, retention and advancement of Indigenous employees", targetText: null, targetValue: null, timelineText: "by 2027", dueDate: "2027-12-31", owner: "Bank of Canada", source: src("Reconciliation Action Plan — People pathway", null), provenance: prov("https://www.bankofcanada.ca/wp-content/uploads/2024/09/reconciliation-action-plan.pdf"), dataClass: "public" },
  { id: "rc-boc-culture", rapId: "rap-boc-2024", orgId: "org-boc", sector: "finance", pillar: "respect", commitmentType: "cultural_learning", action: "Build cultural competency across the Bank", deliverable: "Indigenous cultural learning for staff", targetText: null, targetValue: null, timelineText: "by 2027", dueDate: "2027-12-31", owner: "Bank of Canada", source: src("Reconciliation Action Plan — Learning pathway", null), provenance: prov("https://www.bankofcanada.ca/wp-content/uploads/2024/09/reconciliation-action-plan.pdf"), dataClass: "public" },

  // RBC — inaugural RAP (Jun 2025)
  { id: "rc-rbc-rap", rapId: "rap-rbc-2025", orgId: "org-rbc", sector: "finance", pillar: "governance", commitmentType: "governance", action: "Launch inaugural Reconciliation Action Plan", deliverable: "“Pathways to Economic Prosperity” RAP published Jun 2025 (first for RBC)", targetText: null, targetValue: null, timelineText: "by 2028", dueDate: "2028-12-31", owner: "RBC", source: src("RBC launches inaugural Reconciliation Action Plan, National Indigenous History Month 2025"), provenance: prov("https://www.rbc.com/indigenous/_assets-custom/pdfs/reconciliation-action-plan-EN.pdf"), dataClass: "public" },

  // TELUS — RAP + PAIR + land
  { id: "rc-telus-rap", rapId: "rap-telus-2025", orgId: "org-telus", sector: "telecom", pillar: "governance", commitmentType: "governance", action: "Maintain a public Indigenous reconciliation action plan", deliverable: "First technology company in Canada to publicly commit to a RAP (2021); 7th annual report (2025)", targetText: null, targetValue: null, timelineText: null, dueDate: null, owner: "TELUS", source: src("TELUS becomes first technology company in Canada to publicly commit to a RAP (Nov 2021)"), provenance: prov("https://www.telus.com/en/social-impact/indigenous-reconciliation"), dataClass: "public" },
  { id: "rc-telus-pair", rapId: "rap-telus-2025", orgId: "org-telus", sector: "telecom", pillar: "governance", commitmentType: "governance", action: "Achieve third-party reconciliation certification", deliverable: "CCIB PAIR Silver certification", targetText: "PAIR Silver (2025)", targetValue: null, timelineText: "by 2025", dueDate: "2025-12-31", owner: "TELUS", source: src("First tech company in Canada to achieve PAIR Silver (CCIB-verified)"), provenance: prov("https://www.ccib.ca/main/member/telus-communications-inc/", "independently_verified"), dataClass: "public" },
  { id: "rc-telus-land", rapId: "rap-telus-2025", orgId: "org-telus", sector: "telecom", pillar: "environment", commitmentType: "environmental", action: "Restore traditional lands", deliverable: "Land restoration with Piikani + Blood Tribe", targetText: "500 ha", targetValue: 500, timelineText: "by 2025", dueDate: "2025-12-31", owner: "TELUS", source: src("500 hectares restored (Piikani + Blood Tribe), 2025 report"), provenance: prov("https://www.newswire.ca/news-releases/telus-launches-2025-indigenous-reconciliation-and-connectivity-report-827437817.html"), dataClass: "public" },

  // Agnico Eagle — RAP + procurement + community + training + ESTMA(statutory)
  { id: "rc-agnico-rap", rapId: "rap-agnico-2024", orgId: "org-agnico", sector: "mining", pillar: "governance", commitmentType: "governance", action: "Publish a Reconciliation Action Plan", deliverable: "First Canadian-based-and-led miner to publish a RAP (self-asserted, Jul 2024)", targetText: null, targetValue: null, timelineText: null, dueDate: null, owner: "Agnico Eagle", source: src("Reconciliation Action Plan (Jul 2024)"), provenance: prov("https://www.agnicoeagle.com/English/sustainability/Reconciliation-Action-Plan/default.aspx"), dataClass: "public" },
  { id: "rc-agnico-proc", rapId: "rap-agnico-2024", orgId: "org-agnico", sector: "mining", pillar: "economy", commitmentType: "procurement", action: "Sustain Indigenous procurement", deliverable: "~$1B Indigenous procurement (within $1.9B local total)", targetText: "~$1B (2023)", targetValue: 1_000_000_000, timelineText: "by 2023", dueDate: "2023-12-31", owner: "Agnico Eagle", source: src("~$1 billion Indigenous procurement, 2023"), provenance: prov("https://www.prnewswire.com/news-releases/agnico-eagle-reports-first-quarter-2024-results-302127907.html"), dataClass: "public" },
  { id: "rc-agnico-comm", rapId: "rap-agnico-2024", orgId: "org-agnico", sector: "mining", pillar: "community", commitmentType: "community_investment", action: "Invest in Indigenous communities", deliverable: "Donations + sponsorships", targetText: "$16M (2023)", targetValue: 16_000_000, timelineText: "by 2023", dueDate: "2023-12-31", owner: "Agnico Eagle", source: src("$16M community donations & sponsorships, 2023"), provenance: prov("https://www.prnewswire.com/news-releases/agnico-eagle-reports-first-quarter-2024-results-302127907.html"), dataClass: "public" },
  { id: "rc-agnico-train", rapId: "rap-agnico-2024", orgId: "org-agnico", sector: "mining", pillar: "education", commitmentType: "education_training", action: "Fund Inuit training", deliverable: "Annual Inuit training investment", targetText: "$4.6M (2025)", targetValue: 4_600_000, timelineText: "by 2025", dueDate: "2025-12-31", owner: "Agnico Eagle", source: src("$4.6M Inuit training, 2025"), provenance: prov("https://www.agnicoeagle.com/English/sustainability/Reconciliation-Action-Plan/default.aspx"), dataClass: "public" },
  { id: "rc-agnico-estma", rapId: "rap-agnico-2024", orgId: "org-agnico", sector: "mining", pillar: "economy", commitmentType: "other", action: "Report statutory payments to Indigenous governments", deliverable: "ESTMA payments to Nunavut Inuit associations + GN", targetText: "$90M+ (2024)", targetValue: 90_000_000, timelineText: "by 2024", dueDate: "2024-12-31", owner: "Agnico Eagle", source: src("ESTMA 2024: $90M+ to Nunavut Inuit orgs"), provenance: prov("https://s205.q4cdn.com/243646470/files/doc_downloads/estma/AEM-ESTMA-2024.pdf", "statutory"), dataClass: "public" },

  // Enbridge — IRAP goals + $1B procurement target + equity
  { id: "rc-enbridge-rap", rapId: "rap-enbridge-2022", orgId: "org-enbridge", sector: "energy", pillar: "governance", commitmentType: "governance", action: "Deliver the Indigenous Reconciliation Action Plan", deliverable: "22-goal IRAP (2022); 12 of 22 met by end-2024; 2025 refresh adds 20 new commitments", targetText: "22 goals", targetValue: 22, timelineText: "by 2030", dueDate: "2030-12-31", owner: "Enbridge", source: src("2022 inaugural IRAP — 22 commitments"), provenance: prov("https://www.enbridge.com/reports/2022-indigenous-reconciliation-action-plan/about-this-irap"), dataClass: "public" },
  { id: "rc-enbridge-proc", rapId: "rap-enbridge-2022", orgId: "org-enbridge", sector: "energy", pillar: "economy", commitmentType: "procurement", action: "Grow Indigenous & diverse procurement", deliverable: "Target $1B by 2030; $2.757B cumulative ($757M new) to date", targetText: "$1B by 2030", targetValue: 1_000_000_000, timelineText: "by 2030", dueDate: "2030-12-31", owner: "Enbridge", source: src("IRAP Pillar 3: $1B target by 2030; $2.757B cumulative"), provenance: prov("https://www.enbridge.com/reports/2025-indigenous-reconciliation-action-plan-refresh/pillar-3-economic-inclusion-partnerships"), dataClass: "public" },
  { id: "rc-enbridge-equity", rapId: "rap-enbridge-2022", orgId: "org-enbridge", sector: "energy", pillar: "opportunities", commitmentType: "partnership", action: "Enable Indigenous equity ownership", deliverable: "Athabasca Indigenous Investments — 23 communities, 11.57% of 7 oilsands lines", targetText: "$1.12B (2022)", targetValue: 1_120_000_000, timelineText: "by 2022", dueDate: "2022-12-31", owner: "Enbridge", source: src("Athabasca Indigenous Investments: 23 communities, 11.57%, $1.12B (2022)"), provenance: prov("https://www.enbridge.com/media-center/news/details?id=123735"), dataClass: "public" },

  // Suncor — procurement + equity
  { id: "rc-suncor-proc", rapId: "rap-suncor-2023", orgId: "org-suncor", sector: "energy", pillar: "economy", commitmentType: "procurement", action: "Sustain Indigenous procurement", deliverable: "$3.1B Indigenous procurement (20% of total spend)", targetText: "$3.1B / 20% (2023)", targetValue: 3_100_000_000, timelineText: "by 2023", dueDate: "2023-12-31", owner: "Suncor", source: src("2023 Report on Sustainability: $3.1B Indigenous procurement, 20% of total"), provenance: prov("https://www.3blmedia.com/news/indigenous-relations-suncor-2023-report-sustainability"), dataClass: "public" },
  { id: "rc-suncor-equity", rapId: "rap-suncor-2023", orgId: "org-suncor", sector: "energy", pillar: "opportunities", commitmentType: "partnership", action: "Enable Indigenous equity ownership", deliverable: "Astisiy LP — 8 communities, 14.25% of Northern Courier Pipeline", targetText: "14.25% stake", targetValue: 14.25, timelineText: "by 2021", dueDate: "2021-12-31", owner: "Suncor", source: src("Astisiy LP: 8 communities acquired 14.25% of Northern Courier (2021)"), provenance: prov("https://www.globenewswire.com/news-release/2021/09/16/2298240/0/en/Suncor-and-eight-Indigenous-communities-announce-the-acquisition-of-the-Northern-Courier-Pipeline.html"), dataClass: "public" },

  // TC Energy — procurement + training
  { id: "rc-tce-proc", rapId: "rap-tcenergy-2023", orgId: "org-tcenergy", sector: "energy", pillar: "economy", commitmentType: "procurement", action: "Sustain Indigenous procurement", deliverable: "$1.8B Indigenous & Native American procurement", targetText: "$1.8B (2023)", targetValue: 1_800_000_000, timelineText: "by 2023", dueDate: "2023-12-31", owner: "TC Energy", source: src("TC Energy Indigenous page: $1.8B (2023)"), provenance: prov("https://www.tcenergy.com/sustainability/indigenous/"), dataClass: "public" },
  { id: "rc-tce-train", rapId: "rap-tcenergy-2023", orgId: "org-tcenergy", sector: "energy", pillar: "respect", commitmentType: "cultural_learning", action: "Complete Indigenous awareness training", deliverable: "Mandatory cultural awareness training module", targetText: "92% completion (2023)", targetValue: 92, timelineText: "by 2023", dueDate: "2023-12-31", owner: "TC Energy", source: src("92% training completion, 2023"), provenance: prov("https://www.tcenergy.com/sustainability/indigenous/"), dataClass: "public" },

  // Canadian Natural — procurement + relationships
  { id: "rc-cnq-proc", rapId: "rap-cnq-2024", orgId: "org-cnq", sector: "energy", pillar: "economy", commitmentType: "procurement", action: "Grow Indigenous procurement", deliverable: "$855M+ with 212 Indigenous businesses", targetText: "$855M+ (2024)", targetValue: 855_000_000, timelineText: "by 2024", dueDate: "2024-12-31", owner: "Canadian Natural", source: src("$855M+ Indigenous procurement, 212 businesses (2024)"), provenance: prov("https://www.cnrl.com/sustainability/communities/indigenous-relations/"), dataClass: "public" },
  { id: "rc-cnq-rel", rapId: "rap-cnq-2024", orgId: "org-cnq", sector: "energy", pillar: "relationships", commitmentType: "partnership", action: "Maintain Indigenous community relationships", deliverable: "80+ active community relationships", targetText: "80+ communities", targetValue: 80, timelineText: "by 2024", dueDate: "2024-12-31", owner: "Canadian Natural", source: src("80+ community relationships (2024)"), provenance: prov("https://www.cnrl.com/sustainability/communities/indigenous-relations/"), dataClass: "public" },

  // Teck — procurement + community
  { id: "rc-teck-proc", rapId: "rap-teck-2024", orgId: "org-teck", sector: "mining", pillar: "economy", commitmentType: "procurement", action: "Grow Indigenous procurement", deliverable: "Indigenous procurement spend", targetText: "$388M (2023)", targetValue: 388_000_000, timelineText: "by 2023", dueDate: "2023-12-31", owner: "Teck", source: src("2023 sustainability performance: $388M (2023)"), provenance: prov("https://www.globenewswire.com/news-release/2024/03/14/2846753/0/en/teck-reports-2023-sustainability-performance.html"), dataClass: "public" },
  { id: "rc-teck-comm", rapId: "rap-teck-2024", orgId: "org-teck", sector: "mining", pillar: "community", commitmentType: "community_investment", action: "Invest in communities", deliverable: "Community + Indigenous investment (combined)", targetText: "$32M+ (2023)", targetValue: 32_000_000, timelineText: "by 2023", dueDate: "2023-12-31", owner: "Teck", source: src("$32M+ community + Indigenous investment (2023)"), provenance: prov("https://www.globenewswire.com/news-release/2024/03/14/2846753/0/en/teck-reports-2023-sustainability-performance.html"), dataClass: "public" },

  // Government of Canada — statutory 5% procurement target
  { id: "rc-gc-5pct", rapId: "rap-gc-2024", orgId: "org-gc", sector: "government", pillar: "economy", commitmentType: "procurement", action: "Meet the mandatory minimum 5% Indigenous procurement target", deliverable: "Government-wide 5% of contract value to Indigenous business", targetText: "5% target — achieved 6.11%", targetValue: 6.11, timelineText: "by 2024-03-31", dueDate: "2024-03-31", owner: "Indigenous Services Canada", source: src("FY2023-24: $1.241B to Indigenous business = 6.11% government-wide (exceeded 5%)"), provenance: prov("https://open.canada.ca/data/en/dataset/5d27d152-09d8-4303-adc4-0c46b4a9733b", "statutory"), dataClass: "public" },
  { id: "rc-gc-nrcan", rapId: "rap-gc-2024", orgId: "org-gc", sector: "government", pillar: "economy", commitmentType: "procurement", action: "Departmental Indigenous procurement (NRCan)", deliverable: "Natural Resources Canada Indigenous contract value", targetText: "17.0% ($65.8M)", targetValue: 17.0, timelineText: "by 2024-03-31", dueDate: "2024-03-31", owner: "Natural Resources Canada", source: src("ISC 5% dataset FY2023-24: NRCan 16.99%"), provenance: prov("https://open.canada.ca/data/dataset/5d27d152-09d8-4303-adc4-0c46b4a9733b/resource/a0dec98d-de1e-49b9-ad7f-ef61461b56e5", "statutory"), dataClass: "public" },
];
...
export const rollups: CommitmentRollup[] = commitments.map((c) => {
  ...
  return { commitId: c.id, latestStatus: s, percentComplete: PCT[s], observationCount: 1, updatedAt: "2026-06-29T00:00:00.000Z", dataClass: c.dataClass };
});
