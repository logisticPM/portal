...
export const commitments: Commitment[] = [
  ...
  { id: "rc-boc-culture", rapId: "rap-boc-2024", orgId: "org-boc", sector: "finance", pillar: "respect", commitmentType: "cultural_learning", action: "Build cultural competency across the Bank", deliverable: "Indigenous cultural learning for staff", targetText: null, targetValue: null, dueDate: "2027-12-31", owner: "Bank of Canada", source: src("Reconciliation Action Plan — Learning pathway", null), provenance: prov("https://www.bankofcanada.ca/wp-content/uploads/2024/09/reconciliation-action-plan.pdf"), dataClass: "public" },
