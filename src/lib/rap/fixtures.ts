...
export const orgs: RapOrganization[] = [
  ...
  { id: "org-td", name: "TD Bank Group", sector: "finance_banking", sizeBand: "1000_plus", region: "ON", createdAt: "2024-03-04T00:00:00.000Z" },
  { id: "org-vancity", name: "Vancity Credit Union", sector: "finance_banking", sizeBand: "250_999", region: "BC", createdAt: "2024-05-14T00:00:00.000Z" },
  ...
  { id: "org-teck", name: "Teck Resources", sector: "mining_extractive", sizeBand: "1000_plus", region: "BC", createdAt: "2024-06-30T00:00:00.000Z" },
];
...
export const raps: RapDocument[] = [
  ...
  { id: "rap-td-2024", orgId: "org-td", title: "Indigenous Reconciliation Action Plan", jurisdiction: "CA", rapType: null, publicationDate: "2024-03-04", periodStart: "2024-01-01", periodEnd: "2027-12-31", sourceS3Key: "uploads/seed/td.pdf", extractionId: "seed-td", claimBasis: "self_reported", status: "active", createdAt: "2024-03-04T00:00:00.000Z" },
  { id: "rap-vancity-2024", orgId: "org-vancity", title: "Reconciliation & Economic Inclusion Plan", jurisdiction: "CA", rapType: null, publicationDate: "2024-05-14", periodStart: "2024-01-01", periodEnd: "2026-12-31", sourceS3Key: "uploads/seed/vancity.pdf", extractionId: "seed-vancity", claimBasis: "independently_verified", status: "active", createdAt: "2024-05-14T00:00:00.000Z" },
  { id: "rap-suncor-2024", orgId: "org-suncor", title: "Journey of Reconciliation", jurisdiction: "CA", rapType: null, publicationDate: "2024-02-20", periodStart: "2024-01-01", periodEnd: "2028-12-31", sourceS3Key: "uploads/seed/suncor.pdf", extractionId: "seed-suncor", claimBasis: "self_reported", status: "active", createdAt: "2024-02-20T00:00:00.000Z" },
  { id: "rap-gc-2024", orgId: "org-gc", title: "Indigenous Procurement & Employment Commitments", jurisdiction: "CA", rapType: null, publicationDate: "2024-01-15", periodStart: "2024-01-01", periodEnd: "2027-12-31", sourceS3Key: "uploads/seed/gc.pdf", extractionId: "seed-gc", claimBasis: "statutory", status: "active", createdAt: "2024-01-15T00:00:00.000Z" },
  { id: "rap-cn-2024", orgId: "org-cn", title: "Reconciliation Action Plan", jurisdiction: "CA", rapType: null, publicationDate: "2024-04-09", periodStart: "2024-01-01", periodEnd: "2026-12-31", sourceS3Key: "uploads/seed/cn.pdf", extractionId: "seed-cn", claimBasis: "self_reported", status: "active", createdAt: "2024-04-09T00:00:00.000Z" },
  { id: "rap-ctc-2025", orgId: "org-ctc", title: "Indigenous Relations Strategy", jurisdiction: "CA", rapType: null, publicationDate: "2025-01-22", periodStart: "2025-01-01", periodEnd: "2027-12-31", sourceS3Key: "uploads/seed/ctc.pdf", extractionId: "seed-ctc", claimBasis: "self_reported", status: "active", createdAt: "2025-01-22T00:00:00.000Z" },
  { id: "rap-teck-2024", orgId: "org-teck", title: "Reconciliation Action Plan", jurisdiction: "CA", rapType: null, publicationDate: "2024-06-30", periodStart: "2024-01-01", periodEnd: "2027-12-31", sourceS3Key: "uploads/seed/teck.pdf", extractionId: "seed-teck", claimBasis: "self_reported", status: "active", createdAt: "2024-06-30T00:00:00.000Z" },
];
...
export const commitments: Commitment[] = [
  ...
  { id: "c-td-proc", rapId: "rap-td-2024", orgId: "org-td", sector: "finance_banking", pillar: "economy", commitmentType: "procurement", action: "Expand Indigenous supplier spend", deliverable: "Double Indigenous procurement", targetText: "$50M", targetValue: 50_000_000, dueDate: "2026-12-31", owner: "Chief Procurement Officer", source: src("$50 million annually", 5), provenance: prov("uploads/seed/td.pdf", 0.9) },
  { id: "c-td-comm", rapId: "rap-td-2024", orgId: "org-td", sector: "finance_banking", pillar: "community", commitmentType: "community_investment", action: "Invest in Indigenous communities", deliverable: "Community grants program", targetText: "$25M", targetValue: 25_000_000, dueDate: "2027-12-31", owner: "Head of Sustainability", source: src("$25 million in grants", 8), provenance: prov("uploads/seed/td.pdf", 0.88, "independently_verified") },
  { id: "c-vancity-fin", rapId: "rap-vancity-2024", orgId: "org-vancity", sector: "finance_banking", pillar: "economy", commitmentType: "community_investment", action: "Indigenous lending fund", deliverable: "Low-interest capital for Indigenous business", targetText: "$15M", targetValue: 15_000_000, dueDate: "2026-12-31", owner: "Chief Impact Officer", source: src("$15 million lending fund", 4), provenance: prov("uploads/seed/vancity.pdf", 0.87, "independently_verified") },
  { id: "c-vancity-gov", rapId: "rap-vancity-2024", orgId: "org-vancity", sector: "finance_banking", pillar: "governance", commitmentType: "governance", action: "Indigenous advisory council", deliverable: "Establish advisory governance body", targetText: "1 council", targetValue: 1, dueDate: "2025-12-31", owner: "CEO Office", source: src("Indigenous advisory council", 6), provenance: prov("uploads/seed/vancity.pdf", 0.86) },
  { id: "c-suncor-emp", rapId: "rap-suncor-2024", orgId: "org-suncor", sector: "energy", pillar: "employment", commitmentType: "employment", action: "Grow Indigenous workforce", deliverable: "Indigenous hiring and retention program", targetText: "8% of workforce", targetValue: 8, dueDate: "2027-12-31", owner: "VP Human Resources", source: src("8% Indigenous representation", 11), provenance: prov("uploads/seed/suncor.pdf", 0.85) },
  { id: "c-suncor-part", rapId: "rap-suncor-2024", orgId: "org-suncor", sector: "energy", pillar: "opportunities", commitmentType: "partnership", action: "Equity partnerships with Nations", deliverable: "Co-ownership on energy projects", targetText: "$300M", targetValue: 300_000_000, dueDate: "2028-12-31", owner: "VP Indigenous Relations", source: src("$300 million equity", 14), provenance: prov("uploads/seed/suncor.pdf", 0.83) },
  { id: "c-gc-proc", rapId: "rap-gc-2024", orgId: "org-gc", sector: "government", pillar: "economy", commitmentType: "procurement", action: "Meet 5% Indigenous procurement target", deliverable: "Mandatory minimum federal procurement", targetText: "5% of contracts", targetValue: 5, dueDate: "2025-12-31", owner: "PSPC", source: src("minimum 5% of the total value of contracts", 3), provenance: prov("uploads/seed/gc.pdf", 0.95, "statutory") },
  { id: "c-gc-emp", rapId: "rap-gc-2024", orgId: "org-gc", sector: "government", pillar: "employment", commitmentType: "employment", action: "Increase Indigenous public service representation", deliverable: "Representation in the federal workforce", targetText: "4% of employees", targetValue: 4, dueDate: "2027-12-31", owner: "Treasury Board", source: src("4% representation", 6), provenance: prov("uploads/seed/gc.pdf", 0.9, "statutory") },
  { id: "c-cn-train", rapId: "rap-cn-2024", orgId: "org-cn", sector: "transport", pillar: "education", commitmentType: "education_training", action: "Indigenous skills training", deliverable: "Apprenticeship partnerships", targetText: "$5M", targetValue: 5_000_000, dueDate: "2026-12-31", owner: "Chief HR Officer", source: src("$5 million training", 9), provenance: prov("uploads/seed/cn.pdf", 0.84) },
  { id: "c-cn-culture", rapId: "rap-cn-2024", orgId: "org-cn", sector: "transport", pillar: "respect", commitmentType: "cultural_awareness", action: "Cultural competency training", deliverable: "All-employee cultural training", targetText: "20,000 employees", targetValue: 20000, dueDate: "2026-12-31", owner: "Head of Inclusion", source: src("20,000 employees trained", 10), provenance: prov("uploads/seed/cn.pdf", 0.82) },
  { id: "c-ctc-proc", rapId: "rap-ctc-2025", orgId: "org-ctc", sector: "retail", pillar: "economy", commitmentType: "procurement", action: "Indigenous vendor program", deliverable: "Onboard Indigenous suppliers", targetText: "$10M", targetValue: 10_000_000, dueDate: "2027-12-31", owner: "VP Merchandising", source: src("$10 million with Indigenous vendors", 7), provenance: prov("uploads/seed/ctc.pdf", 0.8) },
  { id: "c-ctc-comm", rapId: "rap-ctc-2025", orgId: "org-ctc", sector: "retail", pillar: "community", commitmentType: "community_investment", action: "Support Indigenous youth", deliverable: "Jumpstart Indigenous programs", targetText: "$3M", targetValue: 3_000_000, dueDate: "2026-12-31", owner: "Foundation Director", source: src("$3 million youth programs", 12), provenance: prov("uploads/seed/ctc.pdf", 0.81) },
  { id: "c-teck-proc", rapId: "rap-teck-2024", orgId: "org-teck", sector: "mining_extractive", pillar: "opportunities", commitmentType: "procurement", action: "Indigenous procurement growth", deliverable: "Contracts to Indigenous businesses", targetText: "$200M", targetValue: 200_000_000, dueDate: "2027-12-31", owner: "Supply Chain VP", source: src("$200 million", 15), provenance: prov("uploads/seed/teck.pdf", 0.85) },
  { id: "c-teck-env", rapId: "rap-teck-2024", orgId: "org-teck", sector: "mining_extractive", pillar: "environment", commitmentType: "environmental", action: "Protect traditional lands", deliverable: "Habitat restoration with Nations", targetText: "1200 ha", targetValue: 1200, dueDate: "2027-12-31", owner: "VP Environment", source: src("1,200 hectares", 13), provenance: prov("uploads/seed/teck.pdf", 0.83) },
];
...
export const rollups: CommitmentRollup[] = [
  ...
  { commitId: "c-td-proc", latestStatus: "on_track", percentComplete: 50, observationCount: 1, updatedAt: "2026-03-31T00:00:00.000Z" },
  { commitId: "c-td-comm", latestStatus: "met", percentComplete: 100, observationCount: 1, updatedAt: "2026-06-30T00:00:00.000Z" },
  { commitId: "c-vancity-fin", latestStatus: "met", percentComplete: 100, observationCount: 1, updatedAt: "2026-05-31T00:00:00.000Z" },
  { commitId: "c-vancity-gov", latestStatus: "on_track", percentComplete: 50, observationCount: 1, updatedAt: "2026-01-31T00:00:00.000Z" },
  { commitId: "c-suncor-emp", latestStatus: "on_track", percentComplete: 50, observationCount: 1, updatedAt: "2026-03-31T00:00:00.000Z" },
  { commitId: "c-suncor-part", latestStatus: "not_started", percentComplete: 0, observationCount: 0, updatedAt: "2024-02-20T00:00:00.000Z" },
  { commitId: "c-gc-proc", latestStatus: "met", percentComplete: 100, observationCount: 1, updatedAt: "2026-03-31T00:00:00.000Z" },
  { commitId: "c-gc-emp", latestStatus: "delayed", percentComplete: 25, observationCount: 1, updatedAt: "2026-03-31T00:00:00.000Z" },
  { commitId: "c-cn-train", latestStatus: "on_track", percentComplete: 50, observationCount: 1, updatedAt: "2026-04-30T00:00:00.000Z" },
  { commitId: "c-cn-culture", latestStatus: "on_track", percentComplete: 50, observationCount: 1, updatedAt: "2026-04-30T00:00:00.000Z" },
  { commitId: "c-ctc-proc", latestStatus: "not_started", percentComplete: 0, observationCount: 0, updatedAt: "2025-01-22T00:00:00.000Z" },
  { commitId: "c-ctc-comm", latestStatus: "on_track", percentComplete: 50, observationCount: 1, updatedAt: "2026-06-30T00:00:00.000Z" },
  { commitId: "c-teck-proc", latestStatus: "on_track", percentComplete: 50, observationCount: 1, updatedAt: "2026-06-30T00:00:00.000Z" },
  { commitId: "c-teck-env", latestStatus: "delayed", percentComplete: 25, observationCount: 1, updatedAt: "2026-06-30T00:00:00.000Z" },
];
