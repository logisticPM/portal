...
export const commitments: Commitment[] = [
  { id: "c-rbc-proc", rapId: "rap-rbc-2025", orgId: "org-rbc", sector: "finance", pillar: "economy", commitmentType: "procurement", action: "Grow Indigenous procurement spend", deliverable: "Reach $100M annual Indigenous procurement", targetText: "$100M", targetValue: 100_000_000, timelineText: "by 2027", dueDate: "2027-12-31", owner: "Chief Procurement Officer", source: src("$100 million annually", 7), provenance: prov("uploads/seed/rbc.pdf", 0.9), dataClass: "org_submitted" },
  { id: "c-rbc-emp", rapId: "rap-rbc-2025", orgId: "org-rbc", sector: "finance", pillar: "employment", commitmentType: "employment", action: "Increase Indigenous representation", deliverable: "Indigenous talent hiring program", targetText: "1.5% of workforce", targetValue: 1.5, timelineText: "by 2027", dueDate: "2027-12-31", owner: "CHRO", source: src("1.5% Indigenous representation", 9), provenance: prov("uploads/seed/rbc.pdf", 0.88), dataClass: "org_submitted" },
  { id: "c-agnico-train", rapId: "rap-agnico-2024", orgId: "org-agnico", sector: "mining", pillar: "education", commitmentType: "education_training", action: "Fund Inuit training", deliverable: "Annual Inuit training investment", targetText: "$4.6M", targetValue: 4_600_000, timelineText: "by 2025", dueDate: "2025-12-31", owner: "VP Sustainability", source: src("$4.6 million Inuit training", 12), provenance: prov("uploads/seed/agnico.pdf", 0.91), dataClass: "org_submitted" },
  { id: "c-agnico-proc", rapId: "rap-agnico-2024", orgId: "org-agnico", sector: "mining", pillar: "opportunities", commitmentType: "procurement", action: "Source from Inuit businesses", deliverable: "Maintain Indigenous procurement spend", targetText: "$1B", targetValue: 1_000_000_000, timelineText: "by 2026", dueDate: "2026-12-31", owner: "Supply Chain Lead", source: src("~$1 billion to Indigenous businesses", 14), provenance: prov("uploads/seed/agnico.pdf", 0.87), dataClass: "org_submitted" },
  { id: "c-telus-conn", rapId: "rap-telus-2024", orgId: "org-telus", sector: "telecom", pillar: "opportunities", commitmentType: "partnership", action: "Connect Indigenous communities", deliverable: "Bring broadband to Indigenous lands", targetText: "85 communities", targetValue: 85, timelineText: "by 2026", dueDate: "2026-12-31", owner: "VP Connectivity", source: src("85 communities connected", 7), provenance: prov("uploads/seed/telus.pdf", 0.86), dataClass: "org_submitted" },
  { id: "c-telus-land", rapId: "rap-telus-2024", orgId: "org-telus", sector: "telecom", pillar: "environment", commitmentType: "environmental", action: "Restore traditional lands", deliverable: "Land restoration with Piikani + Blood Tribe", targetText: "500 ha", targetValue: 500, timelineText: "by 2026", dueDate: "2026-12-31", owner: "Sustainability Lead", source: src("500 hectares restored", 9), provenance: prov("uploads/seed/telus.pdf", 0.84), dataClass: "org_submitted" },
  // --- additional demo commitments (fabricated) ---
  { id: "c-td-proc", rapId: "rap-td-2024", orgId: "org-td", sector: "finance", pillar: "economy", commitmentType: "procurement", action: "Expand Indigenous supplier spend", deliverable: "Double Indigenous procurement", targetText: "$50M", targetValue: 50_000_000, timelineText: "by 2026", dueDate: "2026-12-31", owner: "Chief Procurement Officer", source: src("$50 million annually", 5), provenance: prov("uploads/seed/td.pdf", 0.9), dataClass: "org_submitted" },
  { id: "c-td-comm", rapId: "rap-td-2024", orgId: "org-td", sector: "finance", pillar: "community", commitmentType: "community_investment", action: "Invest in Indigenous communities", deliverable: "Community grants program", targetText: "$25M", targetValue: 25_000_000, timelineText: "by 2027", dueDate: "2027-12-31", owner: "Head of Sustainability", source: src("$25 million in grants", 8), provenance: prov("uploads/seed/td.pdf", 0.88, "independently_verified"), dataClass: "org_submitted" },
  { id: "c-vancity-fin", rapId: "rap-vancity-2024", orgId: "org-vancity", sector: "finance", pillar: "economy", commitmentType: "community_investment", action: "Indigenous lending fund", deliverable: "Low-interest capital for Indigenous business", targetText: "$15M", targetValue: 15_000_000, timelineText: "by 2026", dueDate: "2026-12-31", owner: "Chief Impact Officer", source: src("$15 million lending fund", 4), provenance: prov("uploads/seed/vancity.pdf", 0.87, "independently_verified"), dataClass: "org_submitted" },
  { id: "c-vancity-gov", rapId: "rap-vancity-2024", orgId: "org-vancity", sector: "finance", pillar: "governance", commitmentType: "governance", action: "Indigenous advisory council", deliverable: "Establish advisory governance body", targetText: "1 council", targetValue: 1, timelineText: "by 2025", dueDate: "2025-12-31", owner: "CEO Office", source: src("Indigenous advisory council", 6), provenance: prov("uploads/seed/vancity.pdf", 0.86), dataClass: "org_submitted" },
  { id: "c-suncor-emp", rapId: "rap-suncor-2024", orgId: "org-suncor", sector: "energy", pillar: "employment", commitmentType: "employment", action: "Grow Indigenous workforce", deliverable: "Indigenous hiring and retention program", targetText: "8% of workforce", targetValue: 8, timelineText: "by 2027", dueDate: "2027-12-31", owner: "VP Human Resources", source: src("8% Indigenous representation", 11), provenance: prov("uploads/seed/suncor.pdf", 0.85), dataClass: "org_submitted" },
  { id: "c-suncor-part", rapId: "rap-suncor-2024", orgId: "org-suncor", sector: "energy", pillar: "opportunities", commitmentType: "partnership", action: "Equity partnerships with Nations", deliverable: "Co-ownership on energy projects", targetText: "$300M", targetValue: 300_000_000, timelineText: "by 2028", dueDate: "2028-12-31", owner: "VP Indigenous Relations", source: src("$300 million equity", 14), provenance: prov("uploads/seed/suncor.pdf", 0.83), dataClass: "org_submitted" },
  { id: "c-gc-proc", rapId: "rap-gc-2024", orgId: "org-gc", sector: "government", pillar: "economy", commitmentType: "procurement", action: "Meet 5% Indigenous procurement target", deliverable: "Mandatory minimum federal procurement", targetText: "5% of contracts", targetValue: 5, timelineText: "by 2025", dueDate: "2025-12-31", owner: "PSPC", source: src("minimum 5% of the total value of contracts", 3), provenance: prov("uploads/seed/gc.pdf", 0.95, "statutory"), dataClass: "org_submitted" },
  { id: "c-gc-emp", rapId: "rap-gc-2024", orgId: "org-gc", sector: "government", pillar: "employment", commitmentType: "employment", action: "Increase Indigenous public service representation", deliverable: "Representation in the federal workforce", targetText: "4% of employees", targetValue: 4, timelineText: "by 2027", dueDate: "2027-12-31", owner: "Treasury Board", source: src("4% representation", 6), provenance: prov("uploads/seed/gc.pdf", 0.9, "statutory"), dataClass: "org_submitted" },
  { id: "c-cn-train", rapId: "rap-cn-2024", orgId: "org-cn", sector: "transport", pillar: "education", commitmentType: "education_training", action: "Indigenous skills training", deliverable: "Apprenticeship partnerships", targetText: "$5M", targetValue: 5_000_000, timelineText: "by 2026", dueDate: "2026-12-31", owner: "Chief HR Officer", source: src("$5 million training", 9), provenance: prov("uploads/seed/cn.pdf", 0.84), dataClass: "org_submitted" },
  { id: "c-cn-culture", rapId: "rap-cn-2024", orgId: "org-cn", sector: "transport", pillar: "respect", commitmentType: "cultural_learning", action: "Cultural competency training", deliverable: "All-employee cultural training", targetText: "20,000 employees", targetValue: 20000, timelineText: "by 2026", dueDate: "2026-12-31", owner: "Head of Inclusion", source: src("20,000 employees trained", 10), provenance: prov("uploads/seed/cn.pdf", 0.82), dataClass: "org_submitted" },
  { id: "c-ctc-proc", rapId: "rap-ctc-2025", orgId: "org-ctc", sector: "retail", pillar: "economy", commitmentType: "procurement", action: "Indigenous vendor program", deliverable: "Onboard Indigenous suppliers", targetText: "$10M", targetValue: 10_000_000, timelineText: "by 2027", dueDate: "2027-12-31", owner: "VP Merchandising", source: src("$10 million with Indigenous vendors", 7), provenance: prov("uploads/seed/ctc.pdf", 0.8), dataClass: "org_submitted" },
  { id: "c-ctc-comm", rapId: "rap-ctc-2025", orgId: "org-ctc", sector: "retail", pillar: "community", commitmentType: "community_investment", action: "Support Indigenous youth", deliverable: "Jumpstart Indigenous programs", targetText: "$3M", targetValue: 3_000_000, timelineText: "by 2026", dueDate: "2026-12-31", owner: "Foundation Director", source: src("$3 million youth programs", 12), provenance: prov("uploads/seed/ctc.pdf", 0.81), dataClass: "org_submitted" },
  { id: "c-teck-proc", rapId: "rap-teck-2024", orgId: "org-teck", sector: "mining", pillar: "opportunities", commitmentType: "procurement", action: "Indigenous procurement growth", deliverable: "Contracts to Indigenous businesses", targetText: "$200M", targetValue: 200_000_000, timelineText: "by 2027", dueDate: "2027-12-31", owner: "Supply Chain VP", source: src("$200 million", 15), provenance: prov("uploads/seed/teck.pdf", 0.85), dataClass: "org_submitted" },
  { id: "c-teck-env", rapId: "rap-teck-2024", orgId: "org-teck", sector: "mining", pillar: "environment", commitmentType: "environmental", action: "Protect traditional lands", deliverable: "Habitat restoration with Nations", targetText: "1200 ha", targetValue: 1200, timelineText: "by 2027", dueDate: "2027-12-31", owner: "VP Environment", source: src("1,200 hectares", 13), provenance: prov("uploads/seed/teck.pdf", 0.83), dataClass: "org_submitted" },
];
